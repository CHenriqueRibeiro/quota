...
> [!IMPORTANT]
> **Autenticação Flexível (`apiKey`):**
> Você pode informar no parâmetro `apiKey` tanto a sua **Quota API Key** (`qta_live_...`) quanto a **Chave do Próprio Provedor LLM** (ex: `sk-...` da OpenAI, Anthropic, Gemini, etc.).
> 
